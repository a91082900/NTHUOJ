...
void print(const INST *i)
{
	...
	case ADD:  printf(" 10cc   |"); break;
	case SUB:  printf(" 10cc   |"); break;
	case MUL:  printf(" 30cc   |"); break;
	case DIV:  printf(" 50cc   |"); break;
	case EXIT: printf(" 20cc   |"); break;
	case AND:  printf(" 10cc   |"); break;
	case OR:   printf(" 10cc   |"); break;
	case XOR:  printf(" 10cc   |"); break;
	}
	printf("%7d  |\n", totalClock);
}
